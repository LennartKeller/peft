...
def convert_layers_to_xlora(
    ...
    for module in base.modules():
        ...
        if isinstance(module, lora.Linear):
            ...
            new_layer = FXLoraEmbeddingLayer(
                model=xloramodel,
                target=module,
                target_forward=module.forward,
                layer_number=total_swapped,
...
class FXLoraModel(BaseTuner):
    ...
    Args:
        ...
        config ([`FXLoraConfig`]): The configuration of the Lora model.
    ...
    def __init__(
        self,
        model: nn.Module,
        config: Union[dict[str, FXLoraConfig], FXLoraConfig],
        adapter_name: str,
        torch_device: Optional[str] = None,
        ephemeral_gpu_offload: bool = False,
        autocast_adapter_dtype: bool = True,
    ...
    def set_topk_lora(self, value: Optional[int]):
        ...
        """
        classifier: FXLoraClassifier = self.internal_xlora_classifier  # type: ignore
